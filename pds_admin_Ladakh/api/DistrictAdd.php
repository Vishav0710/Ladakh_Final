...
$district_name = districtNameFormat($district_name);
if($district_name=="Error"){
	echo "Error in district name";
	exit();
}
...
writeLog("User ->" ." District added ->". $_SESSION['user'] . "| Requested JSON ->
